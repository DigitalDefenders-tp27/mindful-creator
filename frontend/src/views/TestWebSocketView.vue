    ...
    <div class="connection-panel">
      <div class="url-input">
        ...
        <input 
          ...
          type="text" 
          v-model="wsUrl" 
          placeholder="Enter WebSocket URL, e.g.: wss://gleaming-celebration-production-66cb.up.railway.app/ws"
...
const messages = ref([]);
const wsUrl = ref('wss://gleaming-celebration-production-66cb.up.railway.app/ws');
...
onMounted(() => {
  ...
  addMessage('Backend address: gleaming-celebration-production-66cb.up.railway.app', 'info');
